    ...
    function createProductCard(productInfo, quantity) {
        ...
        return `
            <div class="card mb-3" id="product-${productInfo.id}">
                <div class="row g-0">
                    <div class="col-md-3">
                        <img src="${productInfo.images[0]}" class="img-fluid rounded-start" alt="${productInfo.name}" style="height: 150px; object-fit: cover;">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">${productInfo.name}</h5>
                            <p class="card-text text-muted">${productInfo.description || ''}</p>
                            <p class="card-text">Precio unitario: <strong>USD ${productInfo.cost}</strong></p>
